...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({ meta: [{ title: "Privacy Policy — Souparnika Travels" }, { name: "description", content: "How Souparnika Travels handles your personal information." }] }),
  component: () => (
    <LegalPage title="Privacy Policy" crumb="Privacy Policy">
      <p>This Privacy Policy describes how Souparnika Travels ("we", "us") collects, uses and safeguards the information you share with us when you use our website or book a trip.</p>
      ...
      <h2>Contact</h2>
      <p>Questions about this policy? Email us at hello@souparnikatravels.com.</p>
    </LegalPage>
  ),
});
