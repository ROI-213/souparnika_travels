      ...
      <div className="py-10 bg-secondary/30 min-h-[70vh]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-6">
          ...
          {activeTab === "faqs" && (
            <div className="space-y-4">
              <h2 className="font-display font-extrabold text-xl text-[color:var(--brand-navy)]">
                Frequently Asked Questions ({DEFAULT_FAQS.length})
              </h2>
              <div className="space-y-3">
                {DEFAULT_FAQS.map((faq, i) => (
                  <div key={faq.id} className="p-4 rounded-2xl bg-white border border-border space-y-1">
                    <div className="font-bold text-sm text-[color:var(--brand-navy)] flex items-center gap-2">
                      <span className="h-5 w-5 rounded-full bg-secondary text-[10px] grid place-items-center">{i + 1}</span>
          ...
          {(activeTab as string) === "packages" && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="font-display font-extrabold text-xl text-[color:var(--brand-navy)]">
                    Travel Packages Management ({DEFAULT_PACKAGES.length})
                  </h2>
